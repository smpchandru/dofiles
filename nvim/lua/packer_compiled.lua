...
_G.packer_plugins = {
  ...
  ["vim-go-templates"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/chandru/.local/share/nvim/site/pack/packer/opt/vim-go-templates",
...
vim.cmd [[au FileType tmpl ++once lua require("packer.load")({'vim-go-templates'}, { ft = "tmpl" }, _G.packer_plugins)]]
vim.cmd [[au FileType htmltmpl ++once lua require("packer.load")({'vim-go-templates'}, { ft = "htmltmpl" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'vim-delve', 'go.nvim'}, { ft = "go" }, _G.packer_plugins)]]
...
time([[Sourcing ftdetect script at: /home/chandru/.local/share/nvim/site/pack/packer/opt/vim-go-templates/ftdetect/gotplhtml.vim]], true)
vim.cmd [[source /home/chandru/.local/share/nvim/site/pack/packer/opt/vim-go-templates/ftdetect/gotplhtml.vim]]
time([[Sourcing ftdetect script at: /home/chandru/.local/share/nvim/site/pack/packer/opt/vim-go-templates/ftdetect/gotplhtml.vim]], false)
vim.cmd("augroup END")
